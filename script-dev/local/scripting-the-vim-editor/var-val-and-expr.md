...
##### Listing 6. Flawed test for empty
                    string
...
##### Listing 9. Problem with integer
                    arithmetic
...
For example, you could create a key-mapping (say: `;p`) that
                causes text like the previous paragraph to be displayed within Vim like
                so:
...
##### Listing 10. Highlighting frequently misused
                    words
...
Insertion mappings can involve scripts considerably more sophisticated than
                ...
                the code out into a user-defined function, which the key-mapping can then
                call.
...
However, you might prefer your vertical copies to ignore any intervening
                ...
                also insert an "m", even though the immediately preceding line is
                empty:
...
##### Listing 11. Improving vertical copies to
                    ignore blank
                lines
